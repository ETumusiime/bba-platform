...
-- ======================================================
-- How to use:
-- 1                          Save cover image to D:\BBA Coursebook Images\highres\9781108888073.jpg
-- 2                          This file is located at backend\seed\books\9781108888073.sql
-- 3                          Run:  psql -U postgres -d bba -f "backend\seed\books\9781108888073.sql"
-- ======================================================
...
INSERT INTO book_details (
  ...
  $OV$
This coursebook provides complete coverage of the Cambridge IGCSE                Physics syllabus (0625) and is fully endorsed by Cambridge Assessment International Education.
...
$OV$,
  ...
  ARRAY[
    ...
    'Develops students                   scientific enquiry skills through                 Experimental Skills                features and practical examples',
