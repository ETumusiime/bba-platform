...
export default function BooksPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-blue-50">
      <Navbar title="BBA Book Catalogue" />

      <section className="flex-1 px-6 py-10">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl font-bold text-blue-900 text-center mb-10">
            ...
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                {displayedBooks.map((book) => (
                  <div
                    key={book.id}
                    className="flex bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 p-4"
                  >
                    {/* Left: Book cover */}
                    ...
                    <div className="flex-1 pl-5 flex flex-col justify-center">
                      <h2 className="font-semibold text-blue-800 text-lg mb-1">
